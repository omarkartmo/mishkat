...
BrandingText "MISHKAT Commercial Distribution v1.1.7"
...
Section "MISHKAT Core Installation" SecCore
  ...
  WriteRegStr HKLM "Software\MISHKAT" "Version" "1.1.7"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MISHKAT" "DisplayName" "MISHKAT School Library System"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MISHKAT" "DisplayVersion" "1.1.7"
