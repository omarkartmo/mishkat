...
export const LoginView: React.FC<LoginViewProps> = ({ config, onLogin }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col justify-between relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white py-1 sm:py-3" dir="rtl">
      ...
      {/* Top Header Bar */}
      <header className="relative z-10 w-full mx-auto px-4 py-2 sm:py-3 flex flex-col items-center justify-center text-center space-y-1.5 sm:space-y-2">
        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl overflow-hidden bg-slate-900/70 backdrop-blur-md shadow-xl shadow-black/50 border border-slate-800/80 flex items-center justify-center p-1.5">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-indigo-400 tracking-wide">
            نظام المشكاة
          </h1>
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-2">
        <div className="w-full max-w-[420px] bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-2xl shadow-black/60 space-y-4 sm:space-y-5 my-auto">
          {/* Card Title */}
          ...
          {lockoutSeconds > 0 && (
            <div className="p-3 bg-rose-500/10 border border-rose-500/30 rounded-xl flex items-center gap-2.5 text-rose-300 text-xs animate-pulse">
            ...
            <div className="space-y-1 text-right">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-2.5 bg-slate-950/80 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl text-sm font-mono text-white placeholder-slate-600 transition-colors disabled:opacity-50"
                  required
                />
            ...
            <div className="space-y-1 text-right">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••••••"
                  disabled={lockoutSeconds > 0}
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-950/80 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl text-sm font-mono text-white placeholder-slate-600 transition-colors disabled:opacity-50"
                  required
                />
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none">
      ...
      <footer className="relative z-10 w-full max-w-6xl mx-auto px-4 py-1.5 sm:py-2 text-center text-[11px] text-slate-500">
